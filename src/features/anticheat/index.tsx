  ...
  return (
    <div className="flex h-full gap-4">
      ...
      <div className="flex flex-1 flex-col gap-4 rounded-xl border border-surfaceBorder bg-surface p-5">
        ...
        <div className="flex h-32 items-center justify-center rounded-xl border border-dashed border-white/10 text-sm text-laurelLeaf">
        ...
        <div className="flex gap-2">
          ...
          <button className="rounded-lg border border-surfaceBorder px-4 py-2 text-sm font-medium text-ceilingWhite transition-colors hover:bg-white/5">
            Invalidar
          </button>
          <button className="rounded-lg border border-surfaceBorder px-4 py-2 text-sm font-medium text-ceilingWhite transition-colors hover:bg-white/5">
            Advertir usuário
          </button>
          <button className="rounded-lg bg-red-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-red-500">
            Banir
          </button>
        </div>
      </div>
